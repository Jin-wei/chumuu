...
sys_config = {
    ...
    */
     ...
     */
    image_server: "http://stg.cn.chumuu.com",
    /*
     ...
     */
    //gaode
    map_js : '%3Cscript onload="OnResourceLoaded(\'gaode_map\');" src="https://webapi.amap.com/maps?v=1.3&key=224229e6022eb83252408bd73ca0be39" type="text/javascript"%3E%3C/script%3E',
    //google
    ...
    */
    ...
    /*statistics_js: "%3Cscript%3E"+
                    ...
                    "ga('send', 'pageview');"+
                    "%3C/script%3E",*/
    auto_login_url:"http://stg.cn.chumuu.com/top-dish?login=1&",
    biz_websocket_url:"ws://60.205.227.44:3000/biz",
    countryCode:"cn",
    timeOffset:8,  //from UTC time
    commonBizId: 0,
    no_braintree:true,
    ...
    weixinConfig: {
        ...
        authIsOpen:true,
        jsdIsOpen:true,
        redirect_uri:"http://stg.cn.chumuu.com/wxpay"
    },
