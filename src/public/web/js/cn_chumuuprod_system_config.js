...
sys_config = {
    ...
    */
     ...
     */
    image_server: "http://cn.image.chumuu.com",
    /*
    ...
    */
    ...
    /*statistics_js: "%3Cscript%3E"+
                    ...
                    "ga('send', 'pageview');"+
                    "%3C/script%3E",*/
    auto_login_url:"http://cn.chumuu.com/top-dish?login=1&",
    biz_websocket_url:"ws://123.56.135.216:3000/biz",
    countryCode:"cn",
    ...
    weixinConfig : {
        ...
        authIsOpen:true,
        jsdIsOpen:true,
        redirect_uri:"http://cn.chumuu.com/wxpay"
    },
