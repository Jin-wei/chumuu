...
cp -r src dist
cd dist
cp public/web/js/cn_chumuuprod_system_config.js public/web/js/system_config.js
cp lib/config/cn_chumuuprod_SystemConfig.js lib/config/SystemConfig.js
cp lib/config/cn_chumuuprod_LogConfig.js lib/config/LogConfig.js
cp conf_cn_prod.json conf.json
