...
function createResetBizPasswordTemplate(newPassword , callback){
    var emailContent = "";
    fs.readFile(systemConfig.emailTemplates.resetBizPasswordEmailTemplate, 'utf8', function (err, data) {
        if (err) {
...
module.exports = {
    ...
    createResetBizPasswordTemplate : createResetBizPasswordTemplate,
