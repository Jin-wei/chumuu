...
var serverUrl = "http://chumuu.com";

var servicePhone = "408-934-3970";

var elasticUrl = "elasticsearch.pinmudo.com:9200";
...
// var mongoConfig = {
//     connect : 'mongodb://biz:wise@localhost:27017/bizwise'
// }
var mongoConfig = {
    connect : 'mongodb://biz:wise@mongodb.pinmudo.com:27017/bizwise'
}
...
var alipayConfig = {
    ...
    cacert:'cacert.pem',
    return_url:"http://cn.chumuu.com/api/alipay/return",
    notify_url:"http://cn.chumuu.com/api/alipay/notify",
    transport:'https' ,
    input_charset:'utf-8' ,
...
var weixinConfig = {
    ...
    notify_url:'http://cn.chumuu.com/api/wxPayResource',
    redirect_url:"http://cn.chumuu.com/wxpay",
    spbill_create_ip:"123.56.135.216"
}
