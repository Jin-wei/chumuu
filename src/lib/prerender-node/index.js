/** modified version of public prerender-node client to work with restify **/
...
var prerender = module.exports = function(req, res, next) {
    //console.log('berfore pre-render: ');

    if(!prerender.shouldShowPrerenderedPage(req)) return next(true);
...
prerender.shouldShowPrerenderedPage = function(req) {
    //console.log('shouldShowPrerenderedPage???????');
...
prerender.buildApiUrl = function(req) {
   ...
   // console.log(prerenderUrl + forwardSlash + fullUrl);
    var fullUrl = protocol + "://" + req.header('Host') + req.url;
